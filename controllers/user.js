...
exports.user_profile_get=(req,res)=>{
    User.find()
    .then(users=>{
        res.render("user/list" , {users, name: req.user }) 
    })
    .catch(err=>{
        console.log(err);
    })
...
exports.user_detail_get = (req,res)=>{
    ...
    .then(user => {
        res.render("user/detail",{user , name: req.user});
    })
    .catch(err => {
        console.log(err);
    })
...
exports.user_currentDetail_get = (req,res , next)=>{
    ...
    User.findById(user)
    .then(user => {
        res.render("user/myProfile",{user , name: req.user});
    })
    .catch(err => {
        console.log(err);
    })
...
exports.user_edit_get = (req,res)=>{
    ...
    .then(user => {
        res.render("user/edit",{user , name: req.user});
    })
    .catch(err => {
        console.log(err);
    })
