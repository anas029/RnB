...
router.post('/add', isLoggedIn, upload.array('itemImage'), itemCntrl.item_create_post)
...
router.post('/addimg', isLoggedIn, upload.array('itemImage'), itemCntrl.item_addImg_post)
router.post('/edit/image', isLoggedIn, upload.single('itemImage'), itemCntrl.item_edit_post)
router.post('/edit/image/remove', isLoggedIn, itemCntrl.item_image_edit_post)
//BORROW
