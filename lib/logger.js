...
const timeLog = (colorx, context, debug = false) => console.log(`${color.black}[${new Date().toLocaleString()}]${colorx} ${context} ${debug && color.magenta + color.bold + '<========== debug'}${color.reset} `)